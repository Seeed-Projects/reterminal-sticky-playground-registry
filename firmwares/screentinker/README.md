...
The package was built from the official [ScreenTinker MCU repository](https://github.com/renebohne/screentinker_mcu) release tag `v1.1.0` (commit `ec5a0ec`) and is distributed under the upstream MIT license.
...
- **Test Results:**
  ...
  - Long press (1.5s on OK button) interactive System Menu verified.
